...
namespace MI.Application
{
    public class DormitoryService : IDormitoryService
    {
        ...
        public int EditDormitoryOneData(t_Dormitory model)
        {
            int result = _Dormitory.Update(model);
            return result;
        }
        /// <summary>
        /// 根据社区,楼栋,房间号查询房间id
        ...
        /// </summary>
        /// <param name="model">model实体</param>
        public int AddDormitoryOneData(t_Dormitory model)
        {
            int result = _Dormitory.Insert(model);
            return result;
        }
        /// <summary>
        /// 根据id删除一条数据
