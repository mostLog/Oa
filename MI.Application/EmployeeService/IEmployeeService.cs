...
namespace MI.Application
{
    public interface IEmployeeService
    {
        ...
        int UpdateEmployeeInfo(AllEmployeeInfoViewModel allEmployeeInfoViewModel, bool bType = false, bool isJLKF = false);
        ...
        /// <returns></returns>
        int DeleteEmoloyeeByfeid(int feid);
        /// <summary>
        /// excel导出全部数据
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="modelEmployeeInfo"></param>
        /// <returns></returns>
        int AddEmployeeInfo(AllEmployeeInfoViewModel allEmployeeInfoViewModel);
        /// <summary>
        /// 洗衣房数据
        /// </summary>
        /// <returns></returns>
        ...
        int RemovalEmployeeInfoById(int eid);
        /// <summary>
        /// 获取以移走新人数据
        /// </summary>
        ...
        /// <returns></returns>
        int UpdetePassporUrl(Employee employee, string sUrl, string sT);
        /// <summary>
        /// 获得所有员工信息
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns></returns>
        int EditEmployeePwd(ModifyPwdModel model);
    }
}
