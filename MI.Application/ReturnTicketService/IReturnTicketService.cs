...
namespace MI.Application
{
    public interface IReturnTicketService
    {
        ...
        int EditReturnTicketOneData(ReturnTicket oModel, ReturnTicket oldModel = null, bool bIsLogs = true, bool isSendCar = false);

        /// <summary>
        /// 新增
        /// </summary>
        /// <param name="oModel">model实体</param>
        int AddReturnTicketOneData(ReturnTicket oModel, bool bIsLogs = true);
        /// <summary>
        /// 查询主管所在部门的所有机票信息
        /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        int Deletet_ReturnTicket(int id);
        /// <summary>
        /// 根据条件导出
        /// </summary>
