...
namespace MI.Application
{
    public class ReturnTicketService : BaseService<ReturnTicket>, IReturnTicketService
    {
        ...
        public int EditReturnTicketOneData(ReturnTicket oModel, ReturnTicket oldModel = null, bool bIsLogs = true, bool isSendCar = false)
        {
            ...
            return AddModifyRecord(GetSendCarJObjectData(oldModel), GetSendCarJObjectData(oModel), ActionItem.Update, CategoryItem.SendACar, "派车安排");
        }
        /// <summary>
        /// 将实体转化成json数据，新人数据
        /// </summary>
        ...
        /// <returns></returns>
        public int AddModifyRecord(string oldEntity, string newEntity, ActionItem action, CategoryItem category, string tableName)
        {
            ...
            return _modifyRecordService.AddModifyRecordData(record);
        }
        ...
        public int AddReturnTicketOneData(ReturnTicket oModel, bool bIsLogs = true)
        {
            //处理登记查询提示
             DoRegistTip(oModel, oModel.f_eId, "t_ReturnTicket", "机票查询");
            if (!string.IsNullOrWhiteSpace(oModel.f_ToDate.ToString()))
            ...
            return _repository.Insert(oModel);
        }
        /// <summary>
        /// 查询主管所在部门的所有机票信息
        /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public int Deletet_ReturnTicket(int id)
        {
